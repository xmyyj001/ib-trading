...
# Configuration tailored for Scenario A: End-of-day Swing Trader
config_data = {
    "common": {
        "tradingEnabled": False,  # Safety first: enable manually in Firestore
        "enforceFlatEod": False, # Swing trading allows holding positions overnight
        "marketDataType": 2,
        "defaultOrderType": "MKT",   # Market-on-Open is a type of Market order
        "defaultOrderTif": "OPG",    # OPG = On-Open. CRITICAL for end-of-day execution
        "retryCheckMinutes": 1440, # Check for duplicate runs within a 24h window
        "exposure": {
            "overall": 0.9,
            "strategies": {
                "spymacdvixy": 1.0,
